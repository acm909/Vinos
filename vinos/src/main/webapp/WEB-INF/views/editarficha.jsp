			...
			<div class="right_col" role="main">
				...
				<div class="">
					...
					<div class="x_panel">
						...
						<div class="x_content">
							<br />
							<form:form class="form-horizontal" modelAttribute="editarficha"  method="POST" action="modificarficha" >
								<div class="form-group">
									<label for="nombre" class="control-label col-md-3 col-sm-3 col-xs-12">Nombre</label>
									<div class="col-md-9 col-sm-9 col-xs-12">
										<form:input id="nombre" type="text" class="form-control" path="nombre" placeholder="Nombre" value="${ficha.nombre}" />
									</div>
								</div>
								<div class="form-group">
									<label for="year" class="control-label col-md-3 col-sm-3 col-xs-12">Año</label>
									<div class="col-md-9 col-sm-9 col-xs-12" >
										<form:input id="year" type="number" class="form-control" path="year" placeholder="Año" value="${ficha.year}"/>
									</div>
								</div>
								<div class="form-group">
									<label for="precio" class="control-label col-md-3 col-sm-3 col-xs-12">Precio</label>
									<div class="col-md-9 col-sm-9 col-xs-12">
										<form:input id="precio" type="number" class="form-control" path="precio" placeholder="0" value="${ficha.precio}" />
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-9 col-sm-9 col-xs-12">
										<form:input id="descripcionenvejecimiento" type="text" class="form-control" value="${ficha.descripcionenvejecimiento}" path="descripcionenvejecimiento" placeholder="Descripción" />
									</div>
								</div>
								<div class="form-group">
									<label for="maridaje" class="control-label col-md-3 col-sm-3 col-xs-12">Maridaje</label>
									<div class="col-md-9 col-sm-9 col-xs-12">
										<form:input id="maridaje" type="text" class="form-control" path="maridaje" placeholder="Maridaje" value="${ficha.maridaje}" />
									</div>
								</div>
								
								
	                            <div class="form-group">
									<label for="year" class="control-label col-md-3 col-sm-3 col-xs-12">Stock </label>
									<div class="col-md-9 col-sm-9 col-xs-12" >
										<form:input id="year" type="number" class="form-control" path="stock" placeholder="Año" value="${ficha.stock.unidadesRestantes}" />
									</div>
								</div>
								<div class="form-group">
									<label for="urlfoto" class="control-label col-md-3 col-sm-3 col-xs-12">URL de la imagen</label>
									<div class="col-md-9 col-sm-9 col-xs-12">
										<form:input id="urlfoto" type="text" class="form-control" path="urlfoto" placeholder="URL de la imagen" value="${ficha.urlfoto}" />
								...
								<form:input type="hidden" value="${ficha.idficha}" path="id" />
								<form:input type="hidden" value="${ficha.stock.idvino}" path="idstock" />
							</form:form>
						</div>
					</div>
				</div>
